...
export DEEPGTAV_EXPORT_DIR="/media/RAIDONE/curnis/GTAVDataset"
export DATA_ROOT="/home/curnis/result/fcgf/features"
export DATASET=${DATASET:-GTAVDataset}
...
python train.py \
	...
	--kitti_root ${DEEPGTAV_EXPORT_DIR} \
